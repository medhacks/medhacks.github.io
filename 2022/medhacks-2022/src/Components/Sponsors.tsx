...
const Sponsors: FC = () => {
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="sm:w-[100%] md:w-[80%] h-auto ml-auto mr-auto">
      {/* flex  items-center gap-36 mt-10 mb-20"> */}
        ...
        <img src={sponsors} alt="Sponsors Logo"/>
      </div>
      <div className="text-black justify-center font-['Mulish'] bg-[#0000000F] w-[80%] m-auto pt-5 pb-5 rounded-3xl">

        <div className="px-[5px] text-[#E63F21] md:text-2xl text-m justify-center leading 7 font-bold tracking-wide">
          Thank you to this year’s sponsors!
        </div>
        <p className="md:text-xl sm:text-m">
